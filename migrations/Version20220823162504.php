 ...
 */
final class Version20220823162504 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE favoris_recipes (favoris_id INT NOT NULL, recipes_id INT NOT NULL, INDEX IDX_16834BB051E8871B (favoris_id), INDEX IDX_16834BB0FDF2B1FA (recipes_id), PRIMARY KEY(favoris_id, recipes_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE favoris_users (favoris_id INT NOT NULL, users_id INT NOT NULL, INDEX IDX_C7E6D68851E8871B (favoris_id), INDEX IDX_C7E6D68867B3B43D (users_id), PRIMARY KEY(favoris_id, users_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
